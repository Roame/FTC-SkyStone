...
@Autonomous(name = "FoundationMover_ParkOutside_Red")
public class FoundationMover_ParkOutside_Red extends OpMode {
    ...
    public void loop() {
        ...
        switch (state){
            ...
            case STEP10:
                ...
                if(MecDrive.EncoderEqualsTarget(tolerance, 550)){
                    MecDrive.setPower(0);
                    MecDrive.MecanumSetMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                    state=States.STEP11;
                }
