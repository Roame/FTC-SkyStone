...
@Autonomous(name = "FoundationMover_ParkInside_Red")
public class FoundationMover_ParkInside_Red extends OpMode {
        ...
        switch (state){
            ...
            case STEP9:
                ...
                if(gyro.getZ()>-2 && gyro.getZ()<2){
                    MecDrive.initEncoders();
                    MecDrive.SetTargetPosition(-1200);
                    MecDrive.setPower(.8);
                    state=States.STEP10;
                }
            ...
            case STEP11:
                ...
                MecDrive.MecanumGyroRotate(gyro.getZ(), -87.5);
                if(gyro.getZ()>-89.5 && gyro.getZ()<-86){
                    MecDrive.initEncoders();
                    MecDrive.SetTargetPosition(1900);
                    MecDrive.setPower(.8);
                    state=States.STEP12;
                }
